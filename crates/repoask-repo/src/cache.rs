...
/// # Errors
///
/// Returns an error if the resolved cache path fails the safety guard or if filesystem removal
/// fails.
...
/// # Errors
///
/// Returns an error if removing the repository cache directory fails.
...
/// # Errors
///
/// Returns an error if scanning the cache directory fails.
